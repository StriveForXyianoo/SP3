 ...
 <aside class="main-sidebar sidebar-dark-success elevation-4">
    <div class="dropdown">
   	<a href="javascript:void(0)" class="brand-link dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
        ...
        <!--<span class="brand-image img-circle elevation-3 d-flex justify-content-center align-items-center bg-white text-danger font-weight-500" style="width: 38px;height:50px"><?php echo strtoupper(substr($_SESSION['login_firstname'], 0,1).substr($_SESSION['login_lastname'], 0,1)) ?></span>-->
      ...
      <nav class="mt-2">
        ...
        <?php if($_SESSION['login_type'] == 1 ): ?>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./index.php?page=add_department" class="nav-link nav-add_department tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Add Department</p>
                </a>
              </li>
