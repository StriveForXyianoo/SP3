  			...
  			<div class="card col-md-4">
				  ...
				  <h4 class="text-dark text-center"><b> CPSU HINIGARAN POLLING SYSTEM</b></h4>
  					<form id="login-form" >
  						...
  						<center><button class=" btn-block btn-wave col-md-4 btn-primary" type="login">Login</button></center><br>
						 
  					</form>
					  <center><button onclick="document.getElementById('id01').style.display='block'" style="width:auto; col-md-4" class="btn-danger">Create Account</button></center>
  				</div>
  			</div>
  		</div>
  		</div>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="" id="manage_user">
			...
			<form action="" id="manage_user">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							<label for="" class="control-label text-dark">Middle Name</label>
						...
						<div class="form-group">
							<label for="" class="control-label text-dark">Contact No.</label>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<label class="label control-label text-dark">Confirm Password</label>
	...
	<center><button class="btn-block btn-wave btn-primary" style="width:auto;">Save</button></center>
...
<script>
	$('#login-form').submit(function(e){
		e.preventDefault()
		$('#login-form button[type="login"]').attr('disabled',true).html('Logging in...');
		...
		$.ajax({
			...
			error:err=>{
				console.log(err)
		$('#login-form button[type="login"]').removeAttr('disabled').html('Login');
			...
			success:function(resp){
				if(resp == 1){
					...
					$('#login-form').prepend('<div class="alert alert-danger">Error Try Again.</div>')
					$('#login-form button[type="login"]').removeAttr('disabled').html('Login');
				}
			}
		})
