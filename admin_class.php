	...
	function save_answer(){
		extract($_POST);
			foreach($qid as $k => $v){
				...
				$data .= ", user_id='{$_SESSION['studentid']}' ";
				if($type[$k] == 'check_opt'){
			...
			$ss = "INSERT INTO `student_answe_status`(`surveyid`, `studentid`, `STATUS`, `dateanswered`) VALUES ('$survey_id','{$_SESSION['studentid']}','ANSWERED',CURRENT_TIMESTAMP)";
			$this->db->query($ss);
